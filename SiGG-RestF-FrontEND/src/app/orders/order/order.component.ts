...
export class OrderComponent implements OnInit {
	...
	onDeleteOrderItem(orderItemID: number, i: number) {
		if (orderItemID != null) this.service.formData.DeletedOrderItemIDs += orderItemID + ',';   
	...
	updateGrandTotal() {
		...
		this.service.formData.GTotal = parseFloat(this.servicr.formData.GTotal.toFixed(2));   
	}
